...
Current phase: Phase 0/1/2 merged to main and tagged (`v2.0.0-alpha`, `v2.0.1-beta`), implementation complete at the code level; none of their exit conditions are bench-verified yet - see docs/BASELINE.md and docs/PHASE1_NOTES.md and docs/PHASE2_NOTES.md for the outstanding bench checklists before Phase 3  
