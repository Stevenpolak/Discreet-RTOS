...
Current phase: Phase 0/1/2/3/4/5 merged to main and tagged (`v2.0.0-alpha`, `v2.0.1-beta`, `v2.0.2-beta`, `v2.0.3-beta`, `v2.0.4-beta`) - none of Phase 0-5's exit conditions are bench-verified yet, and Phase 5's zero-cross sampling question (see docs/PHASE5_NOTES.md "Considered, not changed") should be the first thing checked - see docs/BASELINE.md, docs/PHASE1_NOTES.md, docs/PHASE2_NOTES.md, docs/PHASE3_NOTES.md, docs/PHASE4_NOTES.md and docs/PHASE5_NOTES.md for the outstanding bench checklists  
