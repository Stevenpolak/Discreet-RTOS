...
Current phase: Phase 0/1/2/3/4/5/6 merged to main and tagged (`v2.0.0-alpha` through `v2.0.5-beta`) - none of Phase 0-6's exit conditions are bench-verified yet; Phase 5's zero-cross sampling question and Phase 6's deadman timing validation (see their own "Considered, not changed"/bench checklists) are the two highest-priority items to check first - see docs/BASELINE.md through docs/PHASE6_NOTES.md for the full outstanding bench checklists  
