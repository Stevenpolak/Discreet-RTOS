...
Current phase: Phase 0/1/2 merged to main and tagged (`v2.0.0-alpha`, `v2.0.1-beta`); Phase 3 (centralize control ownership) implemented, in review - none of Phase 0-3's exit conditions are bench-verified yet - see docs/BASELINE.md, docs/PHASE1_NOTES.md, docs/PHASE2_NOTES.md and docs/PHASE3_NOTES.md for the outstanding bench checklists  
